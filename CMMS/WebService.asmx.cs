...
namespace CMMS
{
    ...
    public class WebService : System.Web.Services.WebService
    {
        ...
        public string GetG(int mid)
        {
            ...
            var getParts =
                new SqlCommand(
                    "SELECT m_parts.id,m_parts.PartId,Part.PartName,mYear,min,max,chPeriod,m_parts.comment" +
                    ",i_measurement.measurement,i_measurement.id as measurid FROM bornatek_cmms.dbo.m_parts" +
