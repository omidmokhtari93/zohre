...
namespace CMMS
{
    ...
    public class WebService : System.Web.Services.WebService
    {
        ...
        public string ReplyDataToDb(ReplyData obj)
        {
            ...
            var cmdsearchpartCm = new SqlCommand(" SELECT dbo.p_forecast.PartId, dbo.p_forecast.tarikh, dbo.p_forecast.m_partId, dbo.p_forecast.id, anbar.PartName " +
                                                 " FROM dbo.p_forecast INNER JOIN " + Sname + " as anbar ON dbo.p_forecast.PartId = anbar.Serial " +
