...
<style>
    ...
    .table td a{ padding: 0 4px;background-color: #5389db;color: white;font-weight: 500;border-radius: 2px;}
    .table td a:hover{ color: white;text-decoration: none;background-color: #1b498e;}
    #txtPartsSearch{width: 100%; border-bottom-right-radius: 0; border-bottom-left-radius: 0;}
...
<div class="panel panel-primary" id="pnlSubSytem" style="display: none;">
    ...
    <div class="panel-body" id="subSearchArea">
        <div style="padding: 5px 15px;">
            <div style="width: 100%; display: inline-block; direction: rtl; position: relative;">
                ...
                <img src="Images/loading.png" id="subsystemLoading" style="width: 20px; height: 20px; position: absolute; top: 31px; left: 7px; display: none;"/>
    ...
    <div class="panel-footer">
        ...
        <button type="button" id="btnAddNewSubSystem" class="button" style="direction: rtl;">مشاهده اجزای ثبت شده 
        </button>
...
18-دقت کنید که دستگاه روغنریزی نداشته و هنگام کار درب دستگاه بسته باشد.</textarea>
    ...
    <div class="panel-footer">
        ...
        <button id="btnFinalSave" style="outline: none;" type="button" class="button" onclick="SendTablesToDB();" tabindex="61">ثبت نهایی
