                ...
                <table id="information">
                    ...
                    <tr>
                        <td colspan="5" style="padding: 0px;">
                            ...
                            <asp:SqlDataSource ID="Sqltools" runat="server" ConnectionString="<%$ ConnectionStrings:CMMS %>" SelectCommand="SELECT  ROW_NUMBER()over (order by s_subtools.id_reptag) as rn,Part.PartName,[count]FROM CMMS.dbo.s_subtools inner join sgdb.inv.Part on s_subtools.tools_id = sgdb.inv.Part.Serial where s_subtools.id_reptag = @subtagId">
                                <SelectParameters>
