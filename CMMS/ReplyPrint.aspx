<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReplyPrint.aspx.cs" Inherits="CMMS.ReplyPrint" %>
            ...
            <table>
                <tr style="height: 100px; text-align: center;">
                    ...
                    <td style="width: 220px;">
                        ...
                        <label id="lblRequestTime" runat="server" style="position: absolute; top: 30px; left: 15px;"></label>
                        <span style="position: absolute; top: 55px; right: 5px;">شماره درخواست :</span>
                        <label id="lblRequestNumber" runat="server" style="position: absolute; top: 75px; left: 15px;"></label>
                    </td>
                </tr>
            </table>
            <table>
