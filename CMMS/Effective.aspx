...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-primary">
        <div class="panel-heading">سیستم اثر گذاری ماشین آلات </div>
        <div class="panel-body">
            <div class="row" style="margin: 0; direction: rtl; text-align: right;">
            
                 <div class="col-md-6">
                    <label>ماشین اثر گذار : </label>
                    <asp:DropDownList id="drmain" AppendDataBoundItems="True" runat="server"  CssClass="form-control"  DataSourceID="sqlmain" DataTextField="name" DataValueField="id" TabIndex="2" AutoPostBack="True"> <asp:ListItem Value="-1">ماشین را انتخاب کنید</asp:ListItem></asp:DropDownList>
                </div>
                <div class="col-md-6">
                    <label>واحد مربوطه : </label>
                    <asp:DropDownList id="drunitmain" AppendDataBoundItems="True" runat="server"  CssClass="form-control"  DataSourceID="sqlunitmain" DataTextField="unit_name" DataValueField="unit_code" TabIndex="1" AutoPostBack="True" OnSelectedIndexChanged="drunit_SelectedIndexChanged"> <asp:ListItem Value="-1">واحد را انتخاب کنید</asp:ListItem></asp:DropDownList>                
                </div>
            </div>
            <hr style="color: blue;"/>
            <div class="row" style="margin: 0; direction: rtl; text-align: right;">
                ...
                <div class="col-md-6">
                    ...
                    <asp:DropDownList id="drsub" AppendDataBoundItems="True" runat="server"  CssClass="form-control"  DataSourceID="sqlsub" DataTextField="name" DataValueField="id" TabIndex="2" AutoPostBack="True"> <asp:ListItem Value="-1">ماشین را انتخاب کنید</asp:ListItem></asp:DropDownList>
                </div>
                <div class="col-md-6">
                    <label>واحد مربوطه : </label>
                    <asp:DropDownList id="drunitsub" AppendDataBoundItems="True" runat="server"  CssClass="form-control"  DataSourceID="sqlunitsub" DataTextField="unit_name" DataValueField="unit_code" TabIndex="1" AutoPostBack="True" OnSelectedIndexChanged="drunitsub_OnSelectedIndexChanged"> <asp:ListItem Value="-1">واحد را انتخاب کنید</asp:ListItem></asp:DropDownList>                
                </div>
            </div>
